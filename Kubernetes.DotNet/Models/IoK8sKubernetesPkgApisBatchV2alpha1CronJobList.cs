...
namespace Kubernetes.DotNet.Model {
  ...
  /// </summary>
  [DataContract]
  public class IoK8sKubernetesPkgApisBatchV2alpha1CronJobList {
    /// <summary>
    ...
    /// </summary>
    /// <value>items is the list of CronJobs.</value>
    [DataMember(Name="items", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "items")]
    public List<IoK8sKubernetesPkgApisBatchV2alpha1CronJob> Items { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class IoK8sKubernetesPkgApisBatchV2alpha1CronJobList {\n");
