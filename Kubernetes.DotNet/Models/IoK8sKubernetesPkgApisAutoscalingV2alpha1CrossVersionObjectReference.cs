...
namespace Kubernetes.DotNet.Model {
  ...
  /// </summary>
  [DataContract]
  public class IoK8sKubernetesPkgApisAutoscalingV2alpha1CrossVersionObjectReference {
    /// <summary>
    ...
    public override string ToString()  {
      ...
      sb.Append("class IoK8sKubernetesPkgApisAutoscalingV2alpha1CrossVersionObjectReference {\n");
