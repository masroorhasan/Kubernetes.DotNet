...
namespace Kubernetes.DotNet.Model {
  ...
  /// </summary>
  [DataContract]
  public class IoK8sKubernetesPkgApisAutoscalingV2alpha1MetricSpec {
    /// <summary>
    ...
    public IoK8sKubernetesPkgApisAutoscalingV2alpha1ObjectMetricSource _Object { get; set; }
    ...
    public IoK8sKubernetesPkgApisAutoscalingV2alpha1PodsMetricSource Pods { get; set; }
    ...
    public IoK8sKubernetesPkgApisAutoscalingV2alpha1ResourceMetricSource Resource { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class IoK8sKubernetesPkgApisAutoscalingV2alpha1MetricSpec {\n");
