...
namespace Kubernetes.DotNet.Model {
  ...
  /// </summary>
  [DataContract]
  public class IoK8sKubernetesPkgApisAdmissionregistrationV1alpha1InitializerConfigurationList {
    /// <summary>
    ...
    /// </summary>
    /// <value>List of InitializerConfiguration.</value>
    [DataMember(Name="items", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "items")]
    public List<IoK8sKubernetesPkgApisAdmissionregistrationV1alpha1InitializerConfiguration> Items { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class IoK8sKubernetesPkgApisAdmissionregistrationV1alpha1InitializerConfigurationList {\n");
