...
namespace Kubernetes.DotNet.Model {
  ...
  /// </summary>
  [DataContract]
  public class IoK8sKubernetesPkgApisBatchV2alpha1CronJob {
    /// <summary>
    ...
    /// </summary>
    /// <value>Specification of the desired behavior of a cron job, including the schedule. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status</value>
    ...
    /// </summary>
    /// <value>Current status of a cron job. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status</value>
    ...
    public override string ToString()  {
      ...
      sb.Append("class IoK8sKubernetesPkgApisBatchV2alpha1CronJob {\n");
