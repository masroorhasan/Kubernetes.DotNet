...
namespace Kubernetes.DotNet.Model {
  ...
  /// </summary>
  [DataContract]
  public class IoK8sKubernetesPkgApisAutoscalingV2alpha1HorizontalPodAutoscalerList {
    /// <summary>
    ...
    /// </summary>
    /// <value>items is the list of horizontal pod autoscaler objects.</value>
    [DataMember(Name="items", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "items")]
    public List<IoK8sKubernetesPkgApisAutoscalingV2alpha1HorizontalPodAutoscaler> Items { get; set; }
    ...
    /// </summary>
    /// <value>metadata is the standard list metadata.</value>
    ...
    public override string ToString()  {
      ...
      sb.Append("class IoK8sKubernetesPkgApisAutoscalingV2alpha1HorizontalPodAutoscalerList {\n");
