...
namespace Kubernetes.DotNet.Model {
  ...
  /// </summary>
  [DataContract]
  public class IoK8sKubernetesPkgApisRbacV1alpha1ClusterRoleList {
    /// <summary>
    ...
    public List<IoK8sKubernetesPkgApisRbacV1alpha1ClusterRole> Items { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class IoK8sKubernetesPkgApisRbacV1alpha1ClusterRoleList {\n");
