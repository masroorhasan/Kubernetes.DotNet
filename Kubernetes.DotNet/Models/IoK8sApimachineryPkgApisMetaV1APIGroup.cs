...
namespace Kubernetes.DotNet.Model {
  ...
  public class IoK8sApimachineryPkgApisMetaV1APIGroup {
    ...
    public List<IoK8sApimachineryPkgApisMetaV1ServerAddressByClientCIDR> ServerAddressByClientCIDRs { get; set; }
    ...
    public List<IoK8sApimachineryPkgApisMetaV1GroupVersionForDiscovery> Versions { get; set; }
