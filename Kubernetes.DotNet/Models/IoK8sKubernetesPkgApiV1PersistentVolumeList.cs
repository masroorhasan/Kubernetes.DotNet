...
namespace Kubernetes.DotNet.Model {
  ...
  public class IoK8sKubernetesPkgApiV1PersistentVolumeList {
    ...
    /// </summary>
    /// <value>List of persistent volumes. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes</value>
    [DataMember(Name="items", EmitDefaultValue=false)]
    [JsonProperty(PropertyName = "items")]
    public List<IoK8sKubernetesPkgApiV1PersistentVolume> Items { get; set; }
