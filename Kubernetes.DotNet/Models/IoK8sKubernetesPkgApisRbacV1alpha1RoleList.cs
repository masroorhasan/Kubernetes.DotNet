...
namespace Kubernetes.DotNet.Model {
  ...
  /// </summary>
  [DataContract]
  public class IoK8sKubernetesPkgApisRbacV1alpha1RoleList {
    /// <summary>
    ...
    public List<IoK8sKubernetesPkgApisRbacV1alpha1Role> Items { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class IoK8sKubernetesPkgApisRbacV1alpha1RoleList {\n");
