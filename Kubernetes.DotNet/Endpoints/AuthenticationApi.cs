...
namespace Kubernetes.DotNet.Api
{
    ...
    public class AuthenticationApi : IAuthenticationApi
    {
        ...
        /// </summary>
        /// <returns>IoK8sApimachineryPkgApisMetaV1APIGroup</returns>            
        public IoK8sApimachineryPkgApisMetaV1APIGroup GetAuthenticationAPIGroup ()
        {
            
    
            var path = "/apis/authentication.k8s.io/";
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling GetAuthenticationAPIGroup: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling GetAuthenticationAPIGroup: " + response.ErrorMessage, response.ErrorMessage);
