...
namespace Kubernetes.DotNet.Api
{
    ...
    public class AppsApi : IAppsApi
    {
        ...
        /// </summary>
        /// <returns>IoK8sApimachineryPkgApisMetaV1APIGroup</returns>            
        public IoK8sApimachineryPkgApisMetaV1APIGroup GetAppsAPIGroup ()
        {
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling GetAppsAPIGroup: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling GetAppsAPIGroup: " + response.ErrorMessage, response.ErrorMessage);
