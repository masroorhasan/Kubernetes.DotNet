...
namespace Kubernetes.DotNet.Api
{
    ...
    public class CertificatesApi : ICertificatesApi
    {
        ...
        /// <returns></returns>
        public CertificatesApi(ApiClient apiClient = null)
        {
        ...
        /// </summary>
        /// <returns>IoK8sApimachineryPkgApisMetaV1APIGroup</returns>            
        public IoK8sApimachineryPkgApisMetaV1APIGroup GetCertificatesAPIGroup ()
        {
            
    
            var path = "/apis/certificates.k8s.io/";
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling GetCertificatesAPIGroup: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling GetCertificatesAPIGroup: " + response.ErrorMessage, response.ErrorMessage);
