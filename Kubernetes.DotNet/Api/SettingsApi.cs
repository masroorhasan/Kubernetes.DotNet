...
namespace Kubernetes.DotNet.Api
{
    ...
    public interface ISettingsApi
    {
        ...
        IoK8sApimachineryPkgApisMetaV1APIGroup GetSettingsAPIGroup ();
    }
    ...
    public class SettingsApi : ISettingsApi
    {
        ...
        /// </summary>
        /// <returns>IoK8sApimachineryPkgApisMetaV1APIGroup</returns>            
        public IoK8sApimachineryPkgApisMetaV1APIGroup GetSettingsAPIGroup ()
        {
            
    
            var path = "/apis/settings.k8s.io/";
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling GetSettingsAPIGroup: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling GetSettingsAPIGroup: " + response.ErrorMessage, response.ErrorMessage);
