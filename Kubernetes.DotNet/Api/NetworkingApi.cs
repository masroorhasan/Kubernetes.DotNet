...
namespace Kubernetes.DotNet.Api
{
    ...
    public class NetworkingApi : INetworkingApi
    {
        ...
        /// </summary>
        /// <returns>IoK8sApimachineryPkgApisMetaV1APIGroup</returns>            
        public IoK8sApimachineryPkgApisMetaV1APIGroup GetNetworkingAPIGroup ()
        {
            
    
            var path = "/apis/networking.k8s.io/";
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling GetNetworkingAPIGroup: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling GetNetworkingAPIGroup: " + response.ErrorMessage, response.ErrorMessage);
