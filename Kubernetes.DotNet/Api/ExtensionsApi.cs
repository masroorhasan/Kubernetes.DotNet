...
namespace Kubernetes.DotNet.Api
{
    ...
    public class ExtensionsApi : IExtensionsApi
    {
        ...
        /// </summary>
        /// <returns>IoK8sApimachineryPkgApisMetaV1APIGroup</returns>            
        public IoK8sApimachineryPkgApisMetaV1APIGroup GetExtensionsAPIGroup ()
        {
            
    
            var path = "/apis/extensions/";
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling GetExtensionsAPIGroup: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling GetExtensionsAPIGroup: " + response.ErrorMessage, response.ErrorMessage);
