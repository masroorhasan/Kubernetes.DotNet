...
namespace Kubernetes.DotNet.Api
{
    ...
    public class PolicyApi : IPolicyApi
    {
        ...
        /// </summary>
        /// <returns>IoK8sApimachineryPkgApisMetaV1APIGroup</returns>            
        public IoK8sApimachineryPkgApisMetaV1APIGroup GetPolicyAPIGroup ()
        {
            
    
            var path = "/apis/policy/";
            ...
            if (((int)response.StatusCode) >= 400)
                throw new ApiException ((int)response.StatusCode, "Error calling GetPolicyAPIGroup: " + response.Content, response.Content);
            else if (((int)response.StatusCode) == 0)
                throw new ApiException ((int)response.StatusCode, "Error calling GetPolicyAPIGroup: " + response.ErrorMessage, response.ErrorMessage);
