...
namespace Kubernetes.DotNet.Model {
  ...
  /// </summary>
  [DataContract]
  public class IoK8sKubernetesPkgApisRbacV1alpha1RoleBinding {
    /// <summary>
    ...
    public List<IoK8sKubernetesPkgApisRbacV1alpha1Subject> Subjects { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class IoK8sKubernetesPkgApisRbacV1alpha1RoleBinding {\n");
