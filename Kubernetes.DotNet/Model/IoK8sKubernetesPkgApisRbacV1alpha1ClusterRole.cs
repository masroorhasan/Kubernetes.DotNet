...
namespace Kubernetes.DotNet.Model {
  ...
  /// </summary>
  [DataContract]
  public class IoK8sKubernetesPkgApisRbacV1alpha1ClusterRole {
    /// <summary>
    ...
    public List<IoK8sKubernetesPkgApisRbacV1alpha1PolicyRule> Rules { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class IoK8sKubernetesPkgApisRbacV1alpha1ClusterRole {\n");
