...
namespace Kubernetes.DotNet.Model {
  ...
  /// </summary>
  [DataContract]
  public class IoK8sKubernetesPkgApisRbacV1alpha1RoleBindingList {
    /// <summary>
    ...
    public List<IoK8sKubernetesPkgApisRbacV1alpha1RoleBinding> Items { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class IoK8sKubernetesPkgApisRbacV1alpha1RoleBindingList {\n");
