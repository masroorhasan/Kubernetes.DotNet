...
namespace Kubernetes.DotNet.Model {
  ...
  /// </summary>
  [DataContract]
  public class IoK8sKubernetesPkgApisSettingsV1alpha1PodPresetList {
    /// <summary>
    ...
    public List<IoK8sKubernetesPkgApisSettingsV1alpha1PodPreset> Items { get; set; }
    ...
    public override string ToString()  {
      ...
      sb.Append("class IoK8sKubernetesPkgApisSettingsV1alpha1PodPresetList {\n");
