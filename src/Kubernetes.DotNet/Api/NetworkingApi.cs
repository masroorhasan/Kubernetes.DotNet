...
namespace Kubernetes.DotNet.Api
{
    ...
    /// </summary>
    public interface INetworkingApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class NetworkingApi : INetworkingApi
    {
        ...
        /// <returns></returns>
        public NetworkingApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< V1APIGroup > GetAPIGroupWithHttpInfo ()
        {
            ...
            var localVarPath = "/apis/networking.k8s.io/";
