...
namespace Kubernetes.DotNet.Api
{
    ...
    /// </summary>
    public interface IApiregistrationApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class ApiregistrationApi : IApiregistrationApi
    {
        ...
        /// <returns></returns>
        public ApiregistrationApi(Configuration configuration = null)
        {
        ...
        public ApiResponse< V1APIGroup > GetAPIGroupWithHttpInfo ()
        {
            ...
            var localVarPath = "/apis/apiregistration.k8s.io/";
