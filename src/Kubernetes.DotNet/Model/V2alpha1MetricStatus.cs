...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2alpha1MetricStatus :  IEquatable<V2alpha1MetricStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2alpha1MetricStatus" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V2alpha1MetricStatus() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V2alpha1MetricStatus" /> class.
        /// </summary>
        ...
        /// <param name="Type">type is the type of metric source.  It will match one of the fields below. (required).</param>
        public V2alpha1MetricStatus(V2alpha1ObjectMetricStatus _Object = default(V2alpha1ObjectMetricStatus), V2alpha1PodsMetricStatus Pods = default(V2alpha1PodsMetricStatus), V2alpha1ResourceMetricStatus Resource = default(V2alpha1ResourceMetricStatus), string Type = default(string))
        {
            // to ensure "Type" is required (not null)
            if (Type == null)
            {
                throw new InvalidDataException("Type is a required property for V2alpha1MetricStatus and cannot be null");
            }
            else
            {
                this.Type = Type;
        ...
        public V2alpha1ObjectMetricStatus _Object { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2alpha1MetricStatus);
        }

        /// <summary>
        /// Returns true if V2alpha1MetricStatus instances are equal
        /// </summary>
        /// <param name="other">Instance of V2alpha1MetricStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2alpha1MetricStatus other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
