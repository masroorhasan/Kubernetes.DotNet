...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1alpha1PodPreset :  IEquatable<V1alpha1PodPreset>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1alpha1PodPreset" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1alpha1PodPreset);
        }

        /// <summary>
        /// Returns true if V1alpha1PodPreset instances are equal
        /// </summary>
        /// <param name="other">Instance of V1alpha1PodPreset to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1alpha1PodPreset other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
