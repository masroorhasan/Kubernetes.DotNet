...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1APIService :  IEquatable<V1beta1APIService>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1APIService" /> class.
        /// </summary>
        ...
        /// <param name="Spec">Spec contains information for locating and communicating with a server.</param>
        /// <param name="Status">Status contains derived information about an API server.</param>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1APIService);
        }

        /// <summary>
        /// Returns true if V1beta1APIService instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1APIService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1APIService other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
