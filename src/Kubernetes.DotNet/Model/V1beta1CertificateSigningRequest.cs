...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1CertificateSigningRequest :  IEquatable<V1beta1CertificateSigningRequest>, IValidatableObject
    {
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1CertificateSigningRequest);
        }

        /// <summary>
        /// Returns true if V1beta1CertificateSigningRequest instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1CertificateSigningRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1CertificateSigningRequest other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
