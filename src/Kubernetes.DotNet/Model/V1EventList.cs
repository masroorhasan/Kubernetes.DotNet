...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1EventList :  IEquatable<V1EventList>, IValidatableObject
    {
        ...
        public V1EventList(string ApiVersion = default(string), List<V1Event> Items = default(List<V1Event>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
