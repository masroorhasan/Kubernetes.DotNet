...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1NamespaceStatus :  IEquatable<V1NamespaceStatus>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="Phase">Phase is the current lifecycle phase of the namespace. More info: https://git.k8s.io/community/contributors/design-proposals/namespaces.md#phases.</param>
