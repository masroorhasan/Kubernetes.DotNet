...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1PersistentVolumeClaim :  IEquatable<V1PersistentVolumeClaim>, IValidatableObject
    {
        ...
        /// <param name="Spec">Spec defines the desired characteristics of a volume requested by a pod author. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims.</param>
        /// <param name="Status">Status represents the current information/status of a persistent volume claim. Read-only. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims.</param>
