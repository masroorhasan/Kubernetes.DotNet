...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1ServiceAccountList :  IEquatable<V1ServiceAccountList>, IValidatableObject
    {
        ...
        /// <param name="Items">List of ServiceAccounts. More info: https://kubernetes.io/docs/tasks/configure-pod-container/configure-service-account/ (required).</param>
        ...
        public V1ServiceAccountList(string ApiVersion = default(string), List<V1ServiceAccount> Items = default(List<V1ServiceAccount>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
