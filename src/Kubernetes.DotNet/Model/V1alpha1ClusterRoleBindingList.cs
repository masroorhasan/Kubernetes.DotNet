...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1alpha1ClusterRoleBindingList :  IEquatable<V1alpha1ClusterRoleBindingList>, IValidatableObject
    {
        ...
        public V1alpha1ClusterRoleBindingList(string ApiVersion = default(string), List<V1alpha1ClusterRoleBinding> Items = default(List<V1alpha1ClusterRoleBinding>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
