...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1beta1StorageClassList :  IEquatable<V1beta1StorageClassList>, IValidatableObject
    {
        ...
        public V1beta1StorageClassList(string ApiVersion = default(string), List<V1beta1StorageClass> Items = default(List<V1beta1StorageClass>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
