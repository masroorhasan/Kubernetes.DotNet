...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1NonResourceAttributes :  IEquatable<V1NonResourceAttributes>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1NonResourceAttributes" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1NonResourceAttributes);
        }

        /// <summary>
        /// Returns true if V1NonResourceAttributes instances are equal
        /// </summary>
        /// <param name="other">Instance of V1NonResourceAttributes to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1NonResourceAttributes other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
