...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1alpha1RoleList :  IEquatable<V1alpha1RoleList>, IValidatableObject
    {
        ...
        public V1alpha1RoleList(string ApiVersion = default(string), List<V1alpha1Role> Items = default(List<V1alpha1Role>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
