...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1HorizontalPodAutoscalerList :  IEquatable<V1HorizontalPodAutoscalerList>, IValidatableObject
    {
        ...
        public V1HorizontalPodAutoscalerList(string ApiVersion = default(string), List<V1HorizontalPodAutoscaler> Items = default(List<V1HorizontalPodAutoscaler>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
