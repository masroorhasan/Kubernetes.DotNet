...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AppsV1beta1DeploymentList :  IEquatable<AppsV1beta1DeploymentList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AppsV1beta1DeploymentList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected AppsV1beta1DeploymentList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="AppsV1beta1DeploymentList" /> class.
        /// </summary>
        ...
        public AppsV1beta1DeploymentList(string ApiVersion = default(string), List<AppsV1beta1Deployment> Items = default(List<AppsV1beta1Deployment>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for AppsV1beta1DeploymentList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        public List<AppsV1beta1Deployment> Items { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AppsV1beta1DeploymentList);
        }

        /// <summary>
        /// Returns true if AppsV1beta1DeploymentList instances are equal
        /// </summary>
        /// <param name="other">Instance of AppsV1beta1DeploymentList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AppsV1beta1DeploymentList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
