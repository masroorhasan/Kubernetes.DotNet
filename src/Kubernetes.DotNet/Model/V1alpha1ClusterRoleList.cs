...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1alpha1ClusterRoleList :  IEquatable<V1alpha1ClusterRoleList>, IValidatableObject
    {
        ...
        public V1alpha1ClusterRoleList(string ApiVersion = default(string), List<V1alpha1ClusterRole> Items = default(List<V1alpha1ClusterRole>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
