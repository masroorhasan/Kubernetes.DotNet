...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1alpha1RoleBindingList :  IEquatable<V1alpha1RoleBindingList>, IValidatableObject
    {
        ...
        public V1alpha1RoleBindingList(string ApiVersion = default(string), List<V1alpha1RoleBinding> Items = default(List<V1alpha1RoleBinding>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
