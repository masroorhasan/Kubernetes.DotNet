...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V2alpha1CronJobList :  IEquatable<V2alpha1CronJobList>, IValidatableObject
    {
        ...
        /// <param name="Items">items is the list of CronJobs. (required).</param>
        ...
        public V2alpha1CronJobList(string ApiVersion = default(string), List<V2alpha1CronJob> Items = default(List<V2alpha1CronJob>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
