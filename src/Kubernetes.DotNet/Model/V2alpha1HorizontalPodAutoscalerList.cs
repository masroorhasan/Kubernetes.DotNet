...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2alpha1HorizontalPodAutoscalerList :  IEquatable<V2alpha1HorizontalPodAutoscalerList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2alpha1HorizontalPodAutoscalerList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V2alpha1HorizontalPodAutoscalerList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V2alpha1HorizontalPodAutoscalerList" /> class.
        /// </summary>
        ...
        /// <param name="Items">items is the list of horizontal pod autoscaler objects. (required).</param>
        ...
        /// <param name="Metadata">metadata is the standard list metadata..</param>
        public V2alpha1HorizontalPodAutoscalerList(string ApiVersion = default(string), List<V2alpha1HorizontalPodAutoscaler> Items = default(List<V2alpha1HorizontalPodAutoscaler>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V2alpha1HorizontalPodAutoscalerList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        public List<V2alpha1HorizontalPodAutoscaler> Items { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2alpha1HorizontalPodAutoscalerList);
        }

        /// <summary>
        /// Returns true if V2alpha1HorizontalPodAutoscalerList instances are equal
        /// </summary>
        /// <param name="other">Instance of V2alpha1HorizontalPodAutoscalerList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2alpha1HorizontalPodAutoscalerList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
