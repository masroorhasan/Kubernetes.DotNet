...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1NamespaceList :  IEquatable<V1NamespaceList>, IValidatableObject
    {
        ...
        /// <param name="Items">Items is the list of Namespace objects in the list. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/namespaces/ (required).</param>
        ...
        public V1NamespaceList(string ApiVersion = default(string), List<V1Namespace> Items = default(List<V1Namespace>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
