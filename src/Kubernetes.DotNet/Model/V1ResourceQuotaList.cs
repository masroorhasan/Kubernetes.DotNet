...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1ResourceQuotaList :  IEquatable<V1ResourceQuotaList>, IValidatableObject
    {
        ...
        /// <param name="Items">Items is a list of ResourceQuota objects. More info: https://git.k8s.io/community/contributors/design-proposals/admission_control_resource_quota.md (required).</param>
        ...
        public V1ResourceQuotaList(string ApiVersion = default(string), List<V1ResourceQuota> Items = default(List<V1ResourceQuota>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
