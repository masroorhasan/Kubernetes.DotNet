...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1NetworkPolicyList :  IEquatable<V1NetworkPolicyList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1NetworkPolicyList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1NetworkPolicyList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1NetworkPolicyList" /> class.
        /// </summary>
        ...
        public V1NetworkPolicyList(string ApiVersion = default(string), List<V1NetworkPolicy> Items = default(List<V1NetworkPolicy>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1NetworkPolicyList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        public List<V1NetworkPolicy> Items { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1NetworkPolicyList);
        }

        /// <summary>
        /// Returns true if V1NetworkPolicyList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1NetworkPolicyList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1NetworkPolicyList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
