...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1beta1StatefulSetList :  IEquatable<V1beta1StatefulSetList>, IValidatableObject
    {
        ...
        public V1beta1StatefulSetList(string ApiVersion = default(string), List<V1beta1StatefulSet> Items = default(List<V1beta1StatefulSet>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
