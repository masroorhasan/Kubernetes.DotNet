...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1TokenReviewStatus :  IEquatable<V1TokenReviewStatus>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1TokenReviewStatus" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1TokenReviewStatus);
        }

        /// <summary>
        /// Returns true if V1TokenReviewStatus instances are equal
        /// </summary>
        /// <param name="other">Instance of V1TokenReviewStatus to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1TokenReviewStatus other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
