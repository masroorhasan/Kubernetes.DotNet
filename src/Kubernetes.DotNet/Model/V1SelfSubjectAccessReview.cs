...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1SelfSubjectAccessReview :  IEquatable<V1SelfSubjectAccessReview>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1SelfSubjectAccessReview" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1SelfSubjectAccessReview() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1SelfSubjectAccessReview" /> class.
        /// </summary>
        ...
        public V1SelfSubjectAccessReview(string ApiVersion = default(string), string Kind = default(string), V1ObjectMeta Metadata = default(V1ObjectMeta), V1SelfSubjectAccessReviewSpec Spec = default(V1SelfSubjectAccessReviewSpec), V1SubjectAccessReviewStatus Status = default(V1SubjectAccessReviewStatus))
        {
            // to ensure "Spec" is required (not null)
            if (Spec == null)
            {
                throw new InvalidDataException("Spec is a required property for V1SelfSubjectAccessReview and cannot be null");
            }
            else
            {
                this.Spec = Spec;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1SelfSubjectAccessReview);
        }

        /// <summary>
        /// Returns true if V1SelfSubjectAccessReview instances are equal
        /// </summary>
        /// <param name="other">Instance of V1SelfSubjectAccessReview to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1SelfSubjectAccessReview other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
