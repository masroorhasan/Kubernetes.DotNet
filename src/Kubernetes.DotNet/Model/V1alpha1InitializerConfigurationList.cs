...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1alpha1InitializerConfigurationList :  IEquatable<V1alpha1InitializerConfigurationList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1alpha1InitializerConfigurationList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1alpha1InitializerConfigurationList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1alpha1InitializerConfigurationList" /> class.
        /// </summary>
        ...
        /// <param name="Items">List of InitializerConfiguration. (required).</param>
        ...
        public V1alpha1InitializerConfigurationList(string ApiVersion = default(string), List<V1alpha1InitializerConfiguration> Items = default(List<V1alpha1InitializerConfiguration>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1alpha1InitializerConfigurationList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        public List<V1alpha1InitializerConfiguration> Items { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1alpha1InitializerConfigurationList);
        }

        /// <summary>
        /// Returns true if V1alpha1InitializerConfigurationList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1alpha1InitializerConfigurationList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1alpha1InitializerConfigurationList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
