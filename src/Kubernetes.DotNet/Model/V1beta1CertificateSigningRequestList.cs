...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1CertificateSigningRequestList :  IEquatable<V1beta1CertificateSigningRequestList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1CertificateSigningRequestList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1beta1CertificateSigningRequestList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1CertificateSigningRequestList" /> class.
        /// </summary>
        ...
        public V1beta1CertificateSigningRequestList(string ApiVersion = default(string), List<V1beta1CertificateSigningRequest> Items = default(List<V1beta1CertificateSigningRequest>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1beta1CertificateSigningRequestList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        public List<V1beta1CertificateSigningRequest> Items { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1CertificateSigningRequestList);
        }

        /// <summary>
        /// Returns true if V1beta1CertificateSigningRequestList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1CertificateSigningRequestList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1CertificateSigningRequestList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
