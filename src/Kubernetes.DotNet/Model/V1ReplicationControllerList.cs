...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1ReplicationControllerList :  IEquatable<V1ReplicationControllerList>, IValidatableObject
    {
        ...
        /// <param name="Items">List of replication controllers. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller (required).</param>
        ...
        public V1ReplicationControllerList(string ApiVersion = default(string), List<V1ReplicationController> Items = default(List<V1ReplicationController>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
