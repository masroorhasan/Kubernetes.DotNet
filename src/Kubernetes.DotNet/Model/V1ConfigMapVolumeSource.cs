...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1ConfigMapVolumeSource :  IEquatable<V1ConfigMapVolumeSource>, IValidatableObject
    {
        ...
        public V1ConfigMapVolumeSource(int? DefaultMode = default(int?), List<V1KeyToPath> Items = default(List<V1KeyToPath>), string Name = default(string), bool? Optional = default(bool?))
        {
