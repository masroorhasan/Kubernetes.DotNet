...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1StorageClass :  IEquatable<V1StorageClass>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1StorageClass" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1StorageClass() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1StorageClass" /> class.
        /// </summary>
        ...
        public V1StorageClass(string ApiVersion = default(string), string Kind = default(string), V1ObjectMeta Metadata = default(V1ObjectMeta), Dictionary<string, string> Parameters = default(Dictionary<string, string>), string Provisioner = default(string))
        {
            // to ensure "Provisioner" is required (not null)
            if (Provisioner == null)
            {
                throw new InvalidDataException("Provisioner is a required property for V1StorageClass and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1StorageClass);
        }

        /// <summary>
        /// Returns true if V1StorageClass instances are equal
        /// </summary>
        /// <param name="other">Instance of V1StorageClass to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1StorageClass other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
