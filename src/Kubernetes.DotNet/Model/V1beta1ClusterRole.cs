...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1ClusterRole :  IEquatable<V1beta1ClusterRole>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1ClusterRole" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1beta1ClusterRole() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1ClusterRole" /> class.
        /// </summary>
        ...
        public V1beta1ClusterRole(string ApiVersion = default(string), string Kind = default(string), V1ObjectMeta Metadata = default(V1ObjectMeta), List<V1beta1PolicyRule> Rules = default(List<V1beta1PolicyRule>))
        {
            // to ensure "Rules" is required (not null)
            if (Rules == null)
            {
                throw new InvalidDataException("Rules is a required property for V1beta1ClusterRole and cannot be null");
            }
            else
            {
                this.Rules = Rules;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1ClusterRole);
        }

        /// <summary>
        /// Returns true if V1beta1ClusterRole instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1ClusterRole to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1ClusterRole other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
