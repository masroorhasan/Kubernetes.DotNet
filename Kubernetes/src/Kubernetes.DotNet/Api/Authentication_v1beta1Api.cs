...
namespace Kubernetes.DotNet.Api
{
    ...
    /// </summary>
    public interface IAuthentication_v1beta1Api : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class Authentication_v1beta1Api : IAuthentication_v1beta1Api
    {
        ...
        /// <returns></returns>
        public Authentication_v1beta1Api(Configuration configuration = null)
        {
        ...
        public ApiResponse< V1beta1TokenReview > CreateTokenReviewWithHttpInfo (V1beta1TokenReview body, string pretty = null)
        {
            ...
            if (body == null)
                throw new ApiException(400, "Missing required parameter 'body' when calling Authentication_v1beta1Api->CreateTokenReview");
