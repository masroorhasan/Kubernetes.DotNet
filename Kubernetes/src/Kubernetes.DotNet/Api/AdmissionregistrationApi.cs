...
namespace Kubernetes.DotNet.Api
{
    ...
    /// </summary>
    public interface IAdmissionregistrationApi : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class AdmissionregistrationApi : IAdmissionregistrationApi
    {
        ...
        public ApiResponse< V1APIGroup > GetAPIGroupWithHttpInfo ()
        {
            ...
            var localVarPath = "/apis/admissionregistration.k8s.io/";
