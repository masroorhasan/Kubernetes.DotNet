...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1PodTemplateList :  IEquatable<V1PodTemplateList>, IValidatableObject
    {
        ...
        public V1PodTemplateList(string ApiVersion = default(string), List<V1PodTemplate> Items = default(List<V1PodTemplate>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
