...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1ComponentStatusList :  IEquatable<V1ComponentStatusList>, IValidatableObject
    {
        ...
        public V1ComponentStatusList(string ApiVersion = default(string), List<V1ComponentStatus> Items = default(List<V1ComponentStatus>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
