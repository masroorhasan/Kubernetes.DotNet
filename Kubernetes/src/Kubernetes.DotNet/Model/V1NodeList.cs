...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1NodeList :  IEquatable<V1NodeList>, IValidatableObject
    {
        ...
        public V1NodeList(string ApiVersion = default(string), List<V1Node> Items = default(List<V1Node>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
