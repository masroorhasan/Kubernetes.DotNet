...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1NodeCondition :  IEquatable<V1NodeCondition>, IValidatableObject
    {
        ...
        public V1NodeCondition(DateTime? LastHeartbeatTime = default(DateTime?), DateTime? LastTransitionTime = default(DateTime?), string Message = default(string), string Reason = default(string), string Status = default(string), string Type = default(string))
        {
