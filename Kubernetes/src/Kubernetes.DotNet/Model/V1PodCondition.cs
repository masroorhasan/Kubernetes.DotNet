...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1PodCondition :  IEquatable<V1PodCondition>, IValidatableObject
    {
        ...
        /// <param name="Status">Status is the status of the condition. Can be True, False, Unknown. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-conditions (required).</param>
        /// <param name="Type">Type is the type of the condition. Currently only Ready. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-conditions (required).</param>
        public V1PodCondition(DateTime? LastProbeTime = default(DateTime?), DateTime? LastTransitionTime = default(DateTime?), string Message = default(string), string Reason = default(string), string Status = default(string), string Type = default(string))
        {
