...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1PodList :  IEquatable<V1PodList>, IValidatableObject
    {
        ...
        /// <param name="Items">List of pods. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md (required).</param>
        ...
        public V1PodList(string ApiVersion = default(string), List<V1Pod> Items = default(List<V1Pod>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
