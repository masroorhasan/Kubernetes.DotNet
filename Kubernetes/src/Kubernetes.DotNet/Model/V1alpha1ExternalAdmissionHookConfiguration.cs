...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1alpha1ExternalAdmissionHookConfiguration :  IEquatable<V1alpha1ExternalAdmissionHookConfiguration>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1alpha1ExternalAdmissionHookConfiguration" /> class.
        /// </summary>
        ...
        /// <param name="ExternalAdmissionHooks">ExternalAdmissionHooks is a list of external admission webhooks and the affected resources and operations..</param>
        ...
        public V1alpha1ExternalAdmissionHookConfiguration(string ApiVersion = default(string), List<V1alpha1ExternalAdmissionHook> ExternalAdmissionHooks = default(List<V1alpha1ExternalAdmissionHook>), string Kind = default(string), V1ObjectMeta Metadata = default(V1ObjectMeta))
        {
        ...
        public List<V1alpha1ExternalAdmissionHook> ExternalAdmissionHooks { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1alpha1ExternalAdmissionHookConfiguration);
        }

        /// <summary>
        /// Returns true if V1alpha1ExternalAdmissionHookConfiguration instances are equal
        /// </summary>
        /// <param name="other">Instance of V1alpha1ExternalAdmissionHookConfiguration to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1alpha1ExternalAdmissionHookConfiguration other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.ExternalAdmissionHooks == other.ExternalAdmissionHooks ||
                    this.ExternalAdmissionHooks != null &&
                    this.ExternalAdmissionHooks.SequenceEqual(other.ExternalAdmissionHooks)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.ExternalAdmissionHooks != null)
                    hash = hash * 59 + this.ExternalAdmissionHooks.GetHashCode();
                if (this.Kind != null)
