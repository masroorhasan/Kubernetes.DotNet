...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1beta1DaemonSetList :  IEquatable<V1beta1DaemonSetList>, IValidatableObject
    {
        ...
        /// <param name="Items">A list of daemon sets. (required).</param>
        ...
        public V1beta1DaemonSetList(string ApiVersion = default(string), List<V1beta1DaemonSet> Items = default(List<V1beta1DaemonSet>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
