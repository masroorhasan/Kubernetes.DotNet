...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1Subject :  IEquatable<V1beta1Subject>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1Subject" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1beta1Subject() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1Subject" /> class.
        /// </summary>
        /// <param name="ApiGroup">APIGroup holds the API group of the referenced subject. Defaults to \&quot;\&quot; for ServiceAccount subjects. Defaults to \&quot;rbac.authorization.k8s.io\&quot; for User and Group subjects..</param>
        ...
        public V1beta1Subject(string ApiGroup = default(string), string Kind = default(string), string Name = default(string), string _Namespace = default(string))
        {
            // to ensure "Kind" is required (not null)
            if (Kind == null)
            {
                throw new InvalidDataException("Kind is a required property for V1beta1Subject and cannot be null");
            }
            else
            {
                this.Kind = Kind;
            ...
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for V1beta1Subject and cannot be null");
            }
            else
            {
                this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1Subject);
        }

        /// <summary>
        /// Returns true if V1beta1Subject instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1Subject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1Subject other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
