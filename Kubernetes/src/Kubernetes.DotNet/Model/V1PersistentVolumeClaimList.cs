...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1PersistentVolumeClaimList :  IEquatable<V1PersistentVolumeClaimList>, IValidatableObject
    {
        ...
        /// <param name="Items">A list of persistent volume claims. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims (required).</param>
        ...
        public V1PersistentVolumeClaimList(string ApiVersion = default(string), List<V1PersistentVolumeClaim> Items = default(List<V1PersistentVolumeClaim>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
