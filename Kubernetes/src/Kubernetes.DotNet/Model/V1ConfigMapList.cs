...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1ConfigMapList :  IEquatable<V1ConfigMapList>, IValidatableObject
    {
        ...
        public V1ConfigMapList(string ApiVersion = default(string), List<V1ConfigMap> Items = default(List<V1ConfigMap>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
