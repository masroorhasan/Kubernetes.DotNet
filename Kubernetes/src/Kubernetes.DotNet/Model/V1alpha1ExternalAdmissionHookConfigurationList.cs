...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1alpha1ExternalAdmissionHookConfigurationList :  IEquatable<V1alpha1ExternalAdmissionHookConfigurationList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1alpha1ExternalAdmissionHookConfigurationList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1alpha1ExternalAdmissionHookConfigurationList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1alpha1ExternalAdmissionHookConfigurationList" /> class.
        /// </summary>
        ...
        /// <param name="Items">List of ExternalAdmissionHookConfiguration. (required).</param>
        ...
        public V1alpha1ExternalAdmissionHookConfigurationList(string ApiVersion = default(string), List<V1alpha1ExternalAdmissionHookConfiguration> Items = default(List<V1alpha1ExternalAdmissionHookConfiguration>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1alpha1ExternalAdmissionHookConfigurationList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        public List<V1alpha1ExternalAdmissionHookConfiguration> Items { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1alpha1ExternalAdmissionHookConfigurationList);
        }

        /// <summary>
        /// Returns true if V1alpha1ExternalAdmissionHookConfigurationList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1alpha1ExternalAdmissionHookConfigurationList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1alpha1ExternalAdmissionHookConfigurationList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
