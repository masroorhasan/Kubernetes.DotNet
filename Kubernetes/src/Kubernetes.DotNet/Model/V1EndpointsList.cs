...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1EndpointsList :  IEquatable<V1EndpointsList>, IValidatableObject
    {
        ...
        public V1EndpointsList(string ApiVersion = default(string), List<V1Endpoints> Items = default(List<V1Endpoints>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
