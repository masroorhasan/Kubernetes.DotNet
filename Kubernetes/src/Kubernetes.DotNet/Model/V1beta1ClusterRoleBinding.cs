...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1ClusterRoleBinding :  IEquatable<V1beta1ClusterRoleBinding>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1ClusterRoleBinding" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1beta1ClusterRoleBinding() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1ClusterRoleBinding" /> class.
        /// </summary>
        ...
        public V1beta1ClusterRoleBinding(string ApiVersion = default(string), string Kind = default(string), V1ObjectMeta Metadata = default(V1ObjectMeta), V1beta1RoleRef RoleRef = default(V1beta1RoleRef), List<V1beta1Subject> Subjects = default(List<V1beta1Subject>))
        {
            // to ensure "RoleRef" is required (not null)
            if (RoleRef == null)
            {
                throw new InvalidDataException("RoleRef is a required property for V1beta1ClusterRoleBinding and cannot be null");
            }
            else
            {
            ...
            if (Subjects == null)
            {
                throw new InvalidDataException("Subjects is a required property for V1beta1ClusterRoleBinding and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1ClusterRoleBinding);
        }

        /// <summary>
        /// Returns true if V1beta1ClusterRoleBinding instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1ClusterRoleBinding to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1ClusterRoleBinding other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
