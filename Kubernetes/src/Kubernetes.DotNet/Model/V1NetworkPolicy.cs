...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1NetworkPolicy :  IEquatable<V1NetworkPolicy>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1NetworkPolicy" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1NetworkPolicy);
        }

        /// <summary>
        /// Returns true if V1NetworkPolicy instances are equal
        /// </summary>
        /// <param name="other">Instance of V1NetworkPolicy to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1NetworkPolicy other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
