...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1SecretEnvSource :  IEquatable<V1SecretEnvSource>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1SecretEnvSource" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1SecretEnvSource);
        }

        /// <summary>
        /// Returns true if V1SecretEnvSource instances are equal
        /// </summary>
        /// <param name="other">Instance of V1SecretEnvSource to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1SecretEnvSource other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
