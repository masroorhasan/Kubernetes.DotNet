...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1LimitRangeList :  IEquatable<V1LimitRangeList>, IValidatableObject
    {
        ...
        /// <param name="Items">Items is a list of LimitRange objects. More info: https://git.k8s.io/community/contributors/design-proposals/admission_control_limit_range.md (required).</param>
        ...
        public V1LimitRangeList(string ApiVersion = default(string), List<V1LimitRange> Items = default(List<V1LimitRange>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
