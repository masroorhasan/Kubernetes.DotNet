...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1ServiceList :  IEquatable<V1ServiceList>, IValidatableObject
    {
        ...
        public V1ServiceList(string ApiVersion = default(string), List<V1Service> Items = default(List<V1Service>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
