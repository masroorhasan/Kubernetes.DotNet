...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1StorageClassList :  IEquatable<V1StorageClassList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1StorageClassList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1StorageClassList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1StorageClassList" /> class.
        /// </summary>
        ...
        public V1StorageClassList(string ApiVersion = default(string), List<V1StorageClass> Items = default(List<V1StorageClass>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1StorageClassList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        public List<V1StorageClass> Items { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1StorageClassList);
        }

        /// <summary>
        /// Returns true if V1StorageClassList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1StorageClassList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1StorageClassList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
