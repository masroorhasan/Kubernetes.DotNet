...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1beta1IngressList :  IEquatable<V1beta1IngressList>, IValidatableObject
    {
        ...
        public V1beta1IngressList(string ApiVersion = default(string), List<V1beta1Ingress> Items = default(List<V1beta1Ingress>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
