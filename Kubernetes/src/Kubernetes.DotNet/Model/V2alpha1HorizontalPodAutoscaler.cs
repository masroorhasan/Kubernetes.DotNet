...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V2alpha1HorizontalPodAutoscaler :  IEquatable<V2alpha1HorizontalPodAutoscaler>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V2alpha1HorizontalPodAutoscaler" /> class.
        /// </summary>
        ...
        /// <param name="Metadata">metadata is the standard object metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata.</param>
        /// <param name="Spec">spec is the specification for the behaviour of the autoscaler. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status..</param>
        /// <param name="Status">status is the current information about the autoscaler..</param>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V2alpha1HorizontalPodAutoscaler);
        }

        /// <summary>
        /// Returns true if V2alpha1HorizontalPodAutoscaler instances are equal
        /// </summary>
        /// <param name="other">Instance of V2alpha1HorizontalPodAutoscaler to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V2alpha1HorizontalPodAutoscaler other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
