...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1TokenReview :  IEquatable<V1TokenReview>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1TokenReview" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1TokenReview() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1TokenReview" /> class.
        /// </summary>
        ...
        public V1TokenReview(string ApiVersion = default(string), string Kind = default(string), V1ObjectMeta Metadata = default(V1ObjectMeta), V1TokenReviewSpec Spec = default(V1TokenReviewSpec), V1TokenReviewStatus Status = default(V1TokenReviewStatus))
        {
            // to ensure "Spec" is required (not null)
            if (Spec == null)
            {
                throw new InvalidDataException("Spec is a required property for V1TokenReview and cannot be null");
            }
            else
            {
                this.Spec = Spec;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1TokenReview);
        }

        /// <summary>
        /// Returns true if V1TokenReview instances are equal
        /// </summary>
        /// <param name="other">Instance of V1TokenReview to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1TokenReview other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
