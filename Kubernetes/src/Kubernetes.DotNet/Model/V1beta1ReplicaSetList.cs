...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1beta1ReplicaSetList :  IEquatable<V1beta1ReplicaSetList>, IValidatableObject
    {
        ...
        /// <param name="Items">List of ReplicaSets. More info: https://kubernetes.io/docs/concepts/workloads/controllers/replicationcontroller (required).</param>
        ...
        public V1beta1ReplicaSetList(string ApiVersion = default(string), List<V1beta1ReplicaSet> Items = default(List<V1beta1ReplicaSet>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
