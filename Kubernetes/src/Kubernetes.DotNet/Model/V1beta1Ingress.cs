...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1beta1Ingress :  IEquatable<V1beta1Ingress>, IValidatableObject
    {
        ...
        /// <param name="Spec">Spec is the desired state of the Ingress. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status.</param>
        /// <param name="Status">Status is the current state of the Ingress. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status.</param>
