...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1beta1DaemonSet :  IEquatable<V1beta1DaemonSet>, IValidatableObject
    {
        ...
        /// <param name="Spec">The desired behavior of this daemon set. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status.</param>
        /// <param name="Status">The current status of this daemon set. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status.</param>
