...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1JobList :  IEquatable<V1JobList>, IValidatableObject
    {
        ...
        /// <param name="Items">items is the list of Jobs. (required).</param>
        ...
        public V1JobList(string ApiVersion = default(string), List<V1Job> Items = default(List<V1Job>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
