...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ExtensionsV1beta1DeploymentRollback :  IEquatable<ExtensionsV1beta1DeploymentRollback>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtensionsV1beta1DeploymentRollback" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ExtensionsV1beta1DeploymentRollback() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ExtensionsV1beta1DeploymentRollback" /> class.
        /// </summary>
        ...
        public ExtensionsV1beta1DeploymentRollback(string ApiVersion = default(string), string Kind = default(string), string Name = default(string), ExtensionsV1beta1RollbackConfig RollbackTo = default(ExtensionsV1beta1RollbackConfig), Dictionary<string, string> UpdatedAnnotations = default(Dictionary<string, string>))
        {
            // to ensure "Name" is required (not null)
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for ExtensionsV1beta1DeploymentRollback and cannot be null");
            }
            else
            {
                this.Name = Name;
            ...
            if (RollbackTo == null)
            {
                throw new InvalidDataException("RollbackTo is a required property for ExtensionsV1beta1DeploymentRollback and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ExtensionsV1beta1DeploymentRollback);
        }

        /// <summary>
        /// Returns true if ExtensionsV1beta1DeploymentRollback instances are equal
        /// </summary>
        /// <param name="other">Instance of ExtensionsV1beta1DeploymentRollback to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExtensionsV1beta1DeploymentRollback other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
