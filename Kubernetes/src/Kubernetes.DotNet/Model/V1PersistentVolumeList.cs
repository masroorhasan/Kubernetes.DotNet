...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1PersistentVolumeList :  IEquatable<V1PersistentVolumeList>, IValidatableObject
    {
        ...
        /// <param name="Items">List of persistent volumes. More info: https://kubernetes.io/docs/concepts/storage/persistent-volumes (required).</param>
        ...
        public V1PersistentVolumeList(string ApiVersion = default(string), List<V1PersistentVolume> Items = default(List<V1PersistentVolume>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
