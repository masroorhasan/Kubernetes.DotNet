...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1SubjectAccessReview :  IEquatable<V1SubjectAccessReview>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1SubjectAccessReview" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1SubjectAccessReview() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1SubjectAccessReview" /> class.
        /// </summary>
        ...
        public V1SubjectAccessReview(string ApiVersion = default(string), string Kind = default(string), V1ObjectMeta Metadata = default(V1ObjectMeta), V1SubjectAccessReviewSpec Spec = default(V1SubjectAccessReviewSpec), V1SubjectAccessReviewStatus Status = default(V1SubjectAccessReviewStatus))
        {
            // to ensure "Spec" is required (not null)
            if (Spec == null)
            {
                throw new InvalidDataException("Spec is a required property for V1SubjectAccessReview and cannot be null");
            }
            else
            {
                this.Spec = Spec;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1SubjectAccessReview);
        }

        /// <summary>
        /// Returns true if V1SubjectAccessReview instances are equal
        /// </summary>
        /// <param name="other">Instance of V1SubjectAccessReview to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1SubjectAccessReview other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
