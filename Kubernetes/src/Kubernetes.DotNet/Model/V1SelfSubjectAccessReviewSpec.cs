...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1SelfSubjectAccessReviewSpec :  IEquatable<V1SelfSubjectAccessReviewSpec>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1SelfSubjectAccessReviewSpec" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1SelfSubjectAccessReviewSpec);
        }

        /// <summary>
        /// Returns true if V1SelfSubjectAccessReviewSpec instances are equal
        /// </summary>
        /// <param name="other">Instance of V1SelfSubjectAccessReviewSpec to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1SelfSubjectAccessReviewSpec other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
