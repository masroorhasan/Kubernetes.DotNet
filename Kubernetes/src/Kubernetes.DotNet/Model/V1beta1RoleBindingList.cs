...
namespace Kubernetes.DotNet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class V1beta1RoleBindingList :  IEquatable<V1beta1RoleBindingList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1RoleBindingList" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected V1beta1RoleBindingList() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="V1beta1RoleBindingList" /> class.
        /// </summary>
        ...
        public V1beta1RoleBindingList(string ApiVersion = default(string), List<V1beta1RoleBinding> Items = default(List<V1beta1RoleBinding>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
            // to ensure "Items" is required (not null)
            if (Items == null)
            {
                throw new InvalidDataException("Items is a required property for V1beta1RoleBindingList and cannot be null");
            }
            else
            {
                this.Items = Items;
        ...
        public List<V1beta1RoleBinding> Items { get; set; }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as V1beta1RoleBindingList);
        }

        /// <summary>
        /// Returns true if V1beta1RoleBindingList instances are equal
        /// </summary>
        /// <param name="other">Instance of V1beta1RoleBindingList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1beta1RoleBindingList other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
