...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1beta1ThirdPartyResourceList :  IEquatable<V1beta1ThirdPartyResourceList>, IValidatableObject
    {
        ...
        public V1beta1ThirdPartyResourceList(string ApiVersion = default(string), List<V1beta1ThirdPartyResource> Items = default(List<V1beta1ThirdPartyResource>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
