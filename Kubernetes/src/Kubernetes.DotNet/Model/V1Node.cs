...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1Node :  IEquatable<V1Node>, IValidatableObject
    {
        ...
        /// <param name="Spec">Spec defines the behavior of a node. https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status.</param>
        /// <param name="Status">Most recently observed status of the node. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status.</param>
