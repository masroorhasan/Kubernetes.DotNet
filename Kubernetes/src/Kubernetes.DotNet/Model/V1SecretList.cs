...
namespace Kubernetes.DotNet.Model
{
    ...
    public partial class V1SecretList :  IEquatable<V1SecretList>, IValidatableObject
    {
        ...
        /// <param name="Items">Items is a list of secret objects. More info: https://kubernetes.io/docs/concepts/configuration/secret (required).</param>
        ...
        public V1SecretList(string ApiVersion = default(string), List<V1Secret> Items = default(List<V1Secret>), string Kind = default(string), V1ListMeta Metadata = default(V1ListMeta))
        {
