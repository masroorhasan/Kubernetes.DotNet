# Kubernetes.DotNet.Api.ApiregistrationApi
...
namespace Example
{
    public class GetAPIGroupExample
    {
        public void main()
        {
            ...
            var apiInstance = new ApiregistrationApi();
            ...
            {
                Debug.Print("Exception when calling ApiregistrationApi.GetAPIGroup: " + e.Message );
            }
        }
    }
}
